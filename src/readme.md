...
####Todo List: 
1. Clean up plugin structure - make sure its all in one. Registers and Enqueue's its own scripts, ect..
2. Implement PSR-0 standards for autoloading
3. Configure PHPUnit & WP_TestCase
4. Switch over to TDD style of WP Dev
...
1. Use magic helper methods for building URLS: 
	- plugins_url() 
